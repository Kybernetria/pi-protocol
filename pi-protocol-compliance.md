...
The extension entrypoint MUST:

1. ensure the shared fabric exists
2. register the node with that fabric
...
- [ ] `extensions/index.ts` exists
- [ ] bootstrap creates or joins the shared fabric
- [ ] node registers itself with the shared fabric
